...
export const ReservationStatusSchema = z.enum([
  'pending', 'confirmed', 'canceled', 'noShow', 'showedUp', 'late'
]);
...
interface ReservationRepository {
  ...
  findConflicts(date: string, startTime: string, endTime: string): Promise<Reservation[]>;
}
...
export class ReservationService {
  ...
  private async validateTimeSlot(date: string, startTime: string, endTime?: string): Promise<void> {
    const conflicts = await this.repository.findConflicts(date, startTime, endTime);
...
describe('ReservationService', () => {
  ...
  describe('createReservation', () => {
    ...
    it('should throw error for conflicting time slots', async () => {
      ...
      await expect(service.createReservation(reservationData))
